...
export const projectsData: Project[] = [
    {
        title: "teQueenMatch",
        slug: "projects/[slug]",
        description: "Fullstack app containing a API using Express, Node.js and MongoDB and a frontend in React. The purpose of the app is to connect women and non-binary individuals within the tech community, facilitating connections for mentorship, support, and shared experiences.",
        imageUrl: "/images/teQueenMatch.png",
        githubLink: "https://github.com/annikalindberg/teQueenMatch",
        liveUrl: "https://tequeenmatch.netlify.app/",
        tags: ["React JS", "Redux", "Node.js", "Express", "MongoDB", "API", "Axios", "React Testing Library", "Jest", "Google Cloud Platform", "Fullstack"],
    ...
    },
    {
      ...
      slug: "projects/[slug]",
      description: "Developed a comprehensive web presence for DoulaSkapet, utilizing React, React Router, and MUI Material for design and navigation, along with React Helmet for SEO. The site is hosted on Netlify with custom domain setup.",
      tags: ["React JS", "Node.js", "SEO", "Google Analytics", "SEO", "Domain Management", "Node.js"],
      imageUrl: "/images/doulaskapet.png",
      githubLink: "https://github.com/annikalindberg/DoulaSkapet",
      liveUrl: "https://doulaskapet.se/",
      notes: "",
      futureImprovements: ""
    },
    {
      title: "My Code Diary",
      slug: "projects/[slug]",
      description: "A diary app challenge implemented with a focus on scalability and extensibility, featuring Material-UI for the UI components and configured for future API integration. Technologies include React JS, Redux, and Axios.",
      ...
      liveUrl: "https://annikasdiary.netlify.app/",
      notes: "",
      futureImprovements: ""
    },
    {
      ...
      slug: "projects/[slug]",
      description: "A creative take on the Hangman game with a theme suitable for learning Swedish or English words, utilizing React JS, Redux for state management, and Axios for API data fetching.",
      ...
      liveUrl: "https://swedishweatherwords.netlify.app/",
      notes: "",
      futureImprovements: ""
    },
    {
      ...
      slug: "projects/[slug]",
      description: "An Alice in Wonderland-themed labyrinth game leveraging Redux for async actions and reducers, focusing on integrating APIs and creating reusable components. Built with React JS and Redux.",
      ...
      liveUrl: "https://rabbit-hole-labyrinth-annika-fiona.netlify.app/",
      notes: "",
      futureImprovements: ""
    },
    {
      ...
      liveUrl: "https://sweet-unicorn-99f547.netlify.app/",
      notes: "",
      futureImprovements: ""
    },
    {
      title: "To Do App",
      slug: "projects/[slug]",
      description: "A To-Do app emphasizing state management via React and Redux, featuring custom reducers and the createSlice method from Redux Toolkit for a modular approach. Styled with vanilla CSS.",
      ...
      liveUrl: 'https://animated-paletas-c14d00.netlify.app/',
      notes: "",
      futureImprovements: ""
    },
    {
      title: "Space-Quiz Project",
      description: "A collaborative effort to create a quiz application using React and Redux, demonstrating the use of selectors for state access and dispatch for triggering actions. Developed with React JS and Redux.",
      imageUrl: "/images/reduxquiz.png",
      tags: ["CSS3", 'JavaScript', 'React', 'Redux', "Node.js"],
      githubLink: 'https://github.com/annikalindberg/project-redux-space-quiz',
      liveUrl: 'https://annika-spacequiz.netlify.app/',
      notes: "",
      futureImprovements: ""
    },
    {
      title: "Movie releases",
      description: "A React-based multi-page application showcasing client-side navigation with React Router and asynchronous data fetching from an external API, utilizing hooks for enhanced functionality.",
      ...
      liveUrl: 'https://cosmic-daffodil-7c032f.netlify.app/',
      notes: "",
      futureImprovements: ""
    },
    {
      title: "Backend API for Happy Thoughts",
      description: "Developed an Express and MongoDB API featuring endpoints for managing 'Happy Thoughts', including functionality for posting and liking thoughts. Focuses on backend development.",
      imageUrl: "/images/happythoughts.png",
      tags: ['Express', 'Mongo DB', 'JavaScript', "API", "Backend", 'API', "Node.js"],
      githubLink: 'https://github.com/annikalindberg/project-happy-thoughts-api ',
      liveUrl: 'https://happy-thoughts-express-api.onrender.com/',
      notes: "",
      futureImprovements: ""
    },
    {
      title: 'Music releases',
      description: 'A React project showcasing new music releases using the Spotify API, developed through pair programming. Highlights the use of useState hooks for state management.',
      ...
      liveUrl: 'https://anna-annikas.netlify.app/',
      notes: "",
      futureImprovements: ""
    },
    {
      title: 'Weather app',
      description: 'A weather dashboard application built with vanilla JavaScript, displaying current weather and a 5-day forecast by fetching data from a weather API. Developed through pair programming.',
      ...
      liveUrl: 'https://rainbow-rolypoly-c2ce71.netlify.app/',
      notes: "",
      futureImprovements: ""
    },
    {
      title: 'Guess who the game',
      description: 'A digital version of the classic board game "Guess Who", implemented in vanilla JavaScript. Focuses on utilizing objects, arrays, and DOM manipulation.',
      imageUrl: "/images/guess-who.png",
      tags: ["HTML5", "CSS3", 'JavaScript'],
      githubLink: 'https://github.com/AnnikaLindberg/project-guess-who',
      liveUrl: 'https://comforting-fudge-9d6c21.netlify.app/',
      notes: "",
      futureImprovements: ""
    }
