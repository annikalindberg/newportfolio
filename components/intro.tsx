  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold">full-stack developer</span> transitioned from project management and educational consultant into web development in 2020{" "}
